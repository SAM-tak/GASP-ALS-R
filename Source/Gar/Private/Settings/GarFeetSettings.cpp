#include "Settings/GarFeetSettings.h"

#include UE_INLINE_GENERATED_CPP_BY_NAME(GarFeetSettings)

#if WITH_EDITOR
void FGarFootLimitsSettings::PostEditChangeProperty(const FPropertyChangedEvent& PropertyChangedEvent)
{
	TwistAxis.Normalize();
...
void FGarFeetSettings::PostEditChangeProperty(const FPropertyChangedEvent& PropertyChangedEvent)
{
