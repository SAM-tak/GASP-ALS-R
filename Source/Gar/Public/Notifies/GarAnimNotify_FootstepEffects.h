...
#include "GarAnimNotify_FootstepEffects.generated.h"
...
UENUM(BlueprintType)
enum class EGarFootstepSoundType : uint8
{
	Step,
	WalkRun,
	Land
...
UENUM(BlueprintType)
enum class EGarFootstepSoundSpawnMode : uint8
{
...
UENUM(BlueprintType)
enum class EGarFootstepDecalSpawnMode : uint8
{
	SpawnAtTraceHitLocation,
...
UENUM(BlueprintType)
enum class EGarFootstepParticleEffectSpawnMode : uint8
{
	SpawnAtTraceHitLocation,
	SpawnAttachedToFootBone
};
...
struct GAR_API FGarFootstepEffectSettings
{
	GENERATED_BODY()
...
public:
	...
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "GAR")
	EGarFootstepSoundSpawnMode SoundSpawnMode{EGarFootstepSoundSpawnMode::SpawnAtTraceHitLocation};

	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "GAR")
	TSoftObjectPtr<UMaterialInterface> DecalMaterial;

	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "GAR", Meta = (AllowPreserveRatio))
	...
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "GAR")
	EGarFootstepDecalSpawnMode DecalSpawnMode{EGarFootstepDecalSpawnMode::SpawnAttachedToTraceHitComponent};
	...
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "GAR")
	EGarFootstepParticleEffectSpawnMode ParticleSystemSpawnMode{EGarFootstepParticleEffectSpawnMode::SpawnAtTraceHitLocation};
...
class GAR_API UGarFootstepEffectsSettings : public UDataAsset
{
	GENERATED_BODY()
...
UCLASS(DisplayName = "Gar Footstep Effects Animation Notify",
	AutoExpandCategories = ("Settings|Sound", "Settings|Decal", "Settings|Particle System"))
class GAR_API UGarAnimNotify_FootstepEffects : public UAnimNotify
{
	GENERATED_BODY()

protected:
	UPROPERTY(EditAnywhere, BlueprintReadOnly, Category = "Settings")
	TObjectPtr<UGarFootstepEffectsSettings> FootstepEffectsSettings;

	UPROPERTY(EditAnywhere, BlueprintReadOnly, Category = "Settings")
	EGarFootBone FootBone{EGarFootBone::Left};
	...
	UPROPERTY(EditAnywhere, BlueprintReadOnly, Category = "Settings|Sound")
	EGarFootstepSoundType SoundType;
...
private:
	void SpawnSound(USkeletalMeshComponent* Mesh, const FGarFootstepEffectSettings& EffectSettings,
	                const FVector& FootstepLocation, const FQuat& FootstepRotation) const;

	void SpawnDecal(USkeletalMeshComponent* Mesh, const FGarFootstepEffectSettings& EffectSettings,
	                const FVector& FootstepLocation, const FQuat& FootstepRotation,
	                const FHitResult& FootstepHit, const FVector& FootZAxis) const;

	void SpawnParticleSystem(USkeletalMeshComponent* Mesh, const FGarFootstepEffectSettings& EffectSettings,
	                         const FVector& FootstepLocation, const FQuat& FootstepRotation) const;
};
