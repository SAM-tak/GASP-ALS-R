...
#include "GarMoverFallingMode.generated.h"
...
DECLARE_DYNAMIC_MULTICAST_DELEGATE_TwoParams(FGarMover_OnLanded, const FName&, NextMovementModeName, const FHitResult&, HitResult);
...
class UGarMoverFallingMode : public UBaseMovementMode
{
