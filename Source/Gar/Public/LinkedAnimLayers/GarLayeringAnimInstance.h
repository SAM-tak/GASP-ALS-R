...
#include "GarLayeringAnimInstance.generated.h"

UCLASS(Abstract, AutoExpandCategories = ("GAR|Settings"))
class GAR_API UGarLayeringAnimInstance : public UGarLinkedAnimationInstance
{
	GENERATED_BODY()

public:
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "GAR|State", Transient, Meta = (ClampMin = 0, ClampMax = 1))
