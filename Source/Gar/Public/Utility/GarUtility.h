...
#include "GarUtility.generated.h"

struct FBasedMovementInfo;

DECLARE_STATS_GROUP(TEXT("Gar"), STATGROUP_Gar, STATCAT_Advanced)

UCLASS()
class GAR_API UGarUtility : public UBlueprintFunctionLibrary
{
	GENERATED_BODY()
...
public:
	...
	UFUNCTION(BlueprintPure, Category = "GAR|Utility", Meta = (AutoCreateRefTerm = "Name", ReturnDisplayName = "Display String"))
	static FString NameToDisplayString(const FName& Name, bool bNameIsBool);

	UFUNCTION(BlueprintPure, Category = "GAR|Utility",
	...
	UFUNCTION(BlueprintPure, Category = "GAR|Utility", Meta = (AutoCreateRefTerm = "Tag", ReturnDisplayName = "Child Tags"))
	static FGameplayTagContainer GetChildTags(const FGameplayTag& Tag);

	UFUNCTION(BlueprintPure, Category = "GAR|Utility", Meta = (AutoCreateRefTerm = "Tag", ReturnDisplayName = "Tag Name"))
	static FName GetSimpleTagName(const FGameplayTag& Tag);

	UFUNCTION(BlueprintPure, Category = "GAR|Utility", Meta = (WorldContext = "WorldContext", ReturnDisplayName = "Ping"))
	...
	UFUNCTION(BlueprintPure, Category = "GAR|Utility", Meta = (ReturnDisplayName = "Transform"))
	...
	UFUNCTION(BlueprintCallable, Category = "GAR|Utility", Meta = (WorldContext = "WorldContext",
...
constexpr FStringView UGarUtility::BoolToString(const bool bValue)
{
