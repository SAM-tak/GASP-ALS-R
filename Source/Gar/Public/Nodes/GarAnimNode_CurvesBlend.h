...
#include "GarAnimNode_CurvesBlend.generated.h"

UENUM(BlueprintType)
enum class EGarCurvesBlendMode : uint8
{
...
struct GAR_API FGarAnimNode_CurvesBlend : public FAnimNode_Base
{
	GENERATED_BODY()
...
public:
	...
	EGarCurvesBlendMode BlendMode{EGarCurvesBlendMode::BlendByAmount};
#endif
...
public:
	...
	EGarCurvesBlendMode GetBlendMode() const;
};
