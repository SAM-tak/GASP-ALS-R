...
USTRUCT(DisplayName = "Calculate Pole Vector", Meta = (Category = "GAR", NodeColor = "0.05 0.25 0.05"))
struct GAR_API FGarRigUnit_CalculatePoleVector : public FRigUnit
{
	GENERATED_BODY()
...
USTRUCT(DisplayName = "Hand Ik Retargeting", Meta = (Category = "GAR", NodeColor = "0 0.36 1.0"))
struct GAR_API FGarRigUnit_HandIkRetargeting : public FRigUnitMutable
{
	GENERATED_BODY()
