...
public:
	...
	TMap<FGameplayTag, FGameplayTag> DesiredToActualMap{
		...
		{GarDesiredStanceTags::LyingFront, GarStanceTags::LyingFront},
		{GarDesiredStanceTags::LyingBack, GarStanceTags::LyingBack},
	...
	TMap<FGameplayTag, FName> TagToMovementModeMap{
		{GarLocomotionActionTags::Sliding,   TEXT("Sliding")},
